...
#| tbl-cap: User and producer accuracy based on own formules based on Olofsson et al.. De overall accuracy is {{round(est, 3)}} met een variantie van {{round(var, 2)}}.
...
#| tbl-cap: User and producer accuracy based on own formules based on the MAPAC package. De overall accuracy is {{round(est, 3)}} met een variantie van {{round(var, 3)}}.
...
```{r}
#| label: fig-UA_PA
#| fig-cap: "UA and PA based on the Regenesees package."
