...
De clustering werd toegepast op de gegeven dataset. De functie 'change_frequency' werd gebruikt als clusteringsmethode. Na de clustering werd de overall accuracy (OA) de user accuracy (UA) en producer accuracy bepaald (PA) (@tbl-output_clustering) en geplot (@fig-UA_PA). Tijdens deze berekening werd er geen rekening gehouden met de oppervlakte verhouding van elk stratum. 
